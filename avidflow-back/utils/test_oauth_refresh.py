...
Run inside Docker container:
    python -m utils.test_oauth_refresh mock
    python -m utils.test_oauth_refresh list
    python -m utils.test_oauth_refresh check 123
    python -m utils.test_oauth_refresh expire 123
    python -m utils.test_oauth_refresh refresh 123
"""
...
def cmd_expire(cred_id: int):
    ...
    with get_sync_session_manual() as s:
        ...
        print(f"Now run: python -m utils.test_oauth_refresh refresh {cred_id}")
        return True
...
Usage:
    python -m utils.test_oauth_refresh <command> [args]
