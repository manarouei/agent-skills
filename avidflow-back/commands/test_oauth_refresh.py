...
Run inside Docker container:
    python commands/test_oauth_refresh.py mock
    python commands/test_oauth_refresh.py mock-all
    python commands/test_oauth_refresh.py list
    python commands/test_oauth_refresh.py check 123
    python commands/test_oauth_refresh.py expire 123
    python commands/test_oauth_refresh.py refresh 123
"""
...
def cmd_expire(cred_id: str):
    ...
    with get_sync_session_manual() as s:
        ...
        print(f"Now run: python commands/test_oauth_refresh.py refresh {cred_id}")
        return True


def cmd_refresh(cred_id: str):
...
Usage:
    python commands/test_oauth_refresh.py <command> [args]
