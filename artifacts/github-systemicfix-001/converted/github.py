...
Correlation ID: github-systemicfix-001
Generated: 2026-02-01T12:45:22.947584
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['repository', 'release', 'file', 'workflow', 'review', 'issue']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['edit', 'getIssues', 'create', 'getRepositories', 'disable', 'listPopularPaths', 'getUsage', 'getAll', 'get', 'update', 'lock', 'enable', 'createComment', 'listReferrers', 'dispatch', 'getPullRequests', 'delete', 'list', 'getLicense']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['update', 'lock', 'enable', 'createComment', 'listPopularPaths', 'delete', 'list', 'getAll', 'disable', 'listReferrers', 'getUsage', 'edit', 'dispatch', 'getIssues', 'get', 'create', 'getPullRequests', 'getLicense']}}},
