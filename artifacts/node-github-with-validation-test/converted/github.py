...
Correlation ID: node-github-with-validation-test
Generated: 2026-01-07T08:19:15.192214
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['file', 'repository', 'review', 'workflow', 'issue', 'release']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['getLicense', 'getPullRequests', 'disable', 'getIssues', 'listPopularPaths', 'get', 'enable', 'dispatch', 'getAll', 'listReferrers', 'delete', 'update', 'create', 'lock', 'createComment', 'getRepositories', 'edit', 'list', 'getUsage']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['get', 'getLicense', 'lock', 'getUsage', 'enable', 'createComment', 'delete', 'update', 'getPullRequests', 'dispatch', 'edit', 'disable', 'list', 'getIssues', 'getAll', 'create', 'listReferrers', 'listPopularPaths']}}},
