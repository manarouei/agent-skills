...
Correlation ID: node-gitlab-fix33-36-test
Generated: 2026-01-07T08:37:43.650749
...
class GitlabNode(BaseNode):
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['release', 'file', 'repository', 'issue']}}},
    ...
    def _file_delete(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request
        response = self._api_request('DELETE', f'{baseEndpoint}/repository/files/{file_path_encoded}', body=body, query=None)
    ...
    def _file_get(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request
        response = self._api_request('GET', f'{baseEndpoint}/repository/files/{file_path_encoded}', body=None, query=query)
