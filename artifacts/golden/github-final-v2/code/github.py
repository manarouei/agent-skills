...
Correlation ID: github-final-v2
Generated: 2026-02-01T09:57:48.749083
...
class GithubNode(BaseNode):
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['issue', 'release', 'file', 'workflow', 'review', 'repository']}}},
                {"name": "Lock", "value": "lock", "description": "Lock an issue", "display_options": {'show': {'resource': ['issue']}}},
                {"name": "Delete", "value": "delete", "description": "Delete a file in repository", "display_options": {'show': {'resource': ['release', 'file']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['createComment', 'lock', 'getIssues', 'getLicense', 'create', 'listReferrers', 'delete', 'list', 'getUsage', 'listPopularPaths', 'enable', 'get', 'update', 'edit', 'getAll', 'getPullRequests', 'dispatch', 'disable', 'getRepositories']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['listReferrers', 'update', 'edit', 'getAll', 'delete', 'createComment', 'lock', 'getPullRequests', 'list', 'getIssues', 'dispatch', 'enable', 'getUsage', 'listPopularPaths', 'getLicense', 'create', 'disable', 'get']}}},
    ...
    def _issue_create(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        body = {'title': title_text, 'body': body_param, 'labels': labels, 'assignees': assignees}
    ...
    def _issue_lock(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Build request body from extracted parameters
        body = {'lockReason': lock_reason}
        # Make API request
