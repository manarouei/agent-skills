...
Correlation ID: node-gitlab-fix37-test
Generated: 2026-01-07T08:39:46.954430
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['issue', 'release', 'repository', 'file']}}},
