...
Correlation ID: convert-github-test
Generated: 2026-02-02T05:35:25.399860
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['file', 'issue', 'review', 'repository', 'release', 'workflow']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['delete', 'getLicense', 'dispatch', 'disable', 'create', 'listReferrers', 'getUsage', 'update', 'listPopularPaths', 'getPullRequests', 'getRepositories', 'edit', 'createComment', 'get', 'lock', 'list', 'getIssues', 'enable', 'getAll']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['get', 'update', 'delete', 'lock', 'edit', 'listPopularPaths', 'getLicense', 'getPullRequests', 'dispatch', 'getAll', 'enable', 'disable', 'create', 'listReferrers', 'list', 'getIssues', 'createComment', 'getUsage']}}},
