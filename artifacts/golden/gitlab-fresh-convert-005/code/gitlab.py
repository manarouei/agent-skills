...
Generated: 2026-02-03T09:34:44.451361
...
class GitlabNode(BaseNode):
    ...
    def _issue_create(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        response = self._api_request('POST', f'/projects/{quote(str(project_id), safe="")}/issues', body=None, query=None)
    ...
    def _issue_createComment(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('POST', f'/projects/{quote(str(project_id), safe="")}/issues/{issue_iid}/notes', body=None, query=None)
        response = response.get('data', response)
    ...
    def _issue_edit(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('PUT', f'/projects/{quote(str(project_id), safe="")}/issues/{issue_iid}', body=None, query=None)
        response = response.get('data', response)
    ...
    def _issue_get(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('GET', f'/projects/{quote(str(project_id), safe="")}/issues/{issue_iid}', body=None, query=None)
        response = response.get('data', response)
    ...
    def _issue_lock(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('PUT', f'/projects/{quote(str(project_id), safe="")}/issues/{issue_iid}', body=body, query=None)
        response = response.get('data', response)
    ...
    def _release_create(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('POST', f'/projects/{quote(str(project_id), safe="")}/releases', body=None, query=None)
        response = response.get('data', response)
    ...
    def _release_update(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('PUT', f'/projects/{id}/releases/{tag_name}', body=None, query=None)
        response = response.get('data', response)
    ...
    def _repository_get(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('GET', f'/projects/{quote(str(project_id), safe="")}', body=None, query=None)
        response = response.get('data', response)
    ...
    def _repository_getIssues(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('GET', f'/projects/{quote(str(project_id), safe="")}/issues', body=None, query=query)
        response = response.get('data', response)
    ...
    def _user_getRepositories(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('GET', f'/users/{quote(str(project_id), safe="")}/projects', body=None, query=None)
        response = response.get('data', response)
    ...
    def _file_delete(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('DELETE', f'/projects/{quote(str(project_id), safe="")}/repository/files/{quote(str(filePath), safe="")}', body=body, query=None)
        response = response.get('data', response)
    ...
    def _file_get(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Make API request (method/endpoint from operation block)
        response = self._api_request('GET', f'/projects/{quote(str(project_id), safe="")}/repository/files/{quote(str(filePath), safe="")}', body=None, query=query)
        response = response.get('data', response)
    ...
    def _file_list(self, item_index: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Build query parameters
        query = {}
        query['per_page'] = self.get_node_parameter('limit', item_index)
        query['page'] = self.get_node_parameter('page', item_index)
        query['path'] = file_path
        
        # Make API request (method/endpoint from operation block)
        response = self._api_request('GET', f'/projects/{quote(str(project_id), safe="")}/repository/tree', body=None, query=query)
        response = response.get('data', response)
