...
Correlation ID: node-gitlab-FINAL2
Generated: 2026-01-07T08:58:21.224781
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['release', 'repository', 'issue', 'file']}}},
