...
Correlation ID: node-github-008
Generated: 2026-01-06T08:26:40.879420
...
class GithubNode(BaseNode):
    ...
    properties = {
        "parameters": [
            ...
            {"name": "labels", "type": NodeParameterType.COLLECTION, "display_name": "Labels", "default": "", "description": "Label to add to issue", "display_options": {'show': {'operation': ['create']}}},
            {"name": "label", "type": NodeParameterType.STRING, "display_name": "Label", "default": "", "description": "Label to add to issue"},
            {"name": "assignees", "type": NodeParameterType.COLLECTION, "display_name": "Assignees", "default": "", "description": "User to assign issue too", "display_options": {'show': {'operation': ['create']}}},
