...
Correlation ID: github-avidflow-v2
Generated: 2026-01-07T10:30:08.176019
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['issue', 'file', 'workflow', 'repository', 'release', 'review']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['getRepositories', 'lock', 'get', 'getAll', 'disable', 'getIssues', 'dispatch', 'update', 'edit', 'listReferrers', 'getLicense', 'create', 'createComment', 'getPullRequests', 'list', 'delete', 'enable', 'getUsage', 'listPopularPaths']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['enable', 'dispatch', 'getUsage', 'update', 'edit', 'lock', 'get', 'getAll', 'listReferrers', 'getLicense', 'create', 'disable', 'createComment', 'getPullRequests', 'listPopularPaths', 'getIssues', 'list', 'delete']}}},
