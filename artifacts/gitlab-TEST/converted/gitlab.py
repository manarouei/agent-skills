...
Correlation ID: gitlab-TEST
Generated: 2026-01-07T08:59:29.636129
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['repository', 'release', 'issue', 'file']}}},
