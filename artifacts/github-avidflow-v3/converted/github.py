...
Correlation ID: github-avidflow-v3
Generated: 2026-01-08T11:09:19.870841
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['workflow', 'review', 'issue', 'repository', 'release', 'file']}}},
                ...
                {"name": "List", "value": "list", "description": "List contents of a folder", "display_options": {'show': {'resource': ['workflow', 'file']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['dispatch', 'listReferrers', 'disable', 'get', 'lock', 'edit', 'listPopularPaths', 'getUsage', 'list', 'createComment', 'getIssues', 'enable', 'getPullRequests', 'delete', 'getRepositories', 'getAll', 'getLicense', 'update', 'create']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['delete', 'dispatch', 'getAll', 'listPopularPaths', 'getLicense', 'getUsage', 'listReferrers', 'update', 'list', 'create', 'get', 'createComment', 'disable', 'getIssues', 'enable', 'lock', 'edit', 'getPullRequests']}}},
