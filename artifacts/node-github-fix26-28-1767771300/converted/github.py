...
Correlation ID: node-github-fix26-28-1767771300
Generated: 2026-01-07T07:50:34.163179
...
class GithubNode(BaseNode):
    ...
    properties = {
        "parameters": [
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['update', 'getRepositories', 'getAll', 'get', 'dispatch', 'list', 'getUsage', 'enable', 'edit', 'disable', 'getLicense', 'delete', 'listPopularPaths', 'create', 'lock', 'getIssues', 'createComment', 'getPullRequests', 'listReferrers']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['create', 'dispatch', 'listReferrers', 'list', 'lock', 'getLicense', 'createComment', 'update', 'getIssues', 'getUsage', 'enable', 'getPullRequests', 'edit', 'disable', 'getAll', 'get', 'delete', 'listPopularPaths']}}},
