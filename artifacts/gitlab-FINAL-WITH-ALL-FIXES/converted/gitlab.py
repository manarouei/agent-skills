...
Correlation ID: gitlab-FINAL-WITH-ALL-FIXES
Generated: 2026-01-07T09:03:25.302521
...
class GitlabNode(BaseNode):
    ...
    properties = {
        "parameters": [
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Project Owner", "default": "", "required": True, "description": "User, group or namespace of the project", "display_options": {'show': {'operation': ['get', 'getAll', 'getRepositories', 'delete', 'update', 'list', 'lock', 'getIssues', 'create', 'createComment', 'edit']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Project Name", "default": "", "required": True, "description": "The name of the project", "display_options": {'show': {'operation': ['get', 'getAll', 'getRepositories', 'delete', 'update', 'list', 'lock', 'getIssues', 'create', 'createComment', 'edit']}}},
