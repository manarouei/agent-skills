...
Correlation ID: gitlab-WORKS
Generated: 2026-01-07T09:01:10.475914
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['release', 'file', 'issue', 'repository']}}},
