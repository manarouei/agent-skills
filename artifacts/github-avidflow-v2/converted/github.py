...
Correlation ID: github-avidflow
Generated: 2026-01-07T10:04:43.387448
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['file', 'release', 'review', 'issue', 'workflow', 'repository']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['getIssues', 'update', 'dispatch', 'getAll', 'list', 'createComment', 'listPopularPaths', 'disable', 'get', 'getPullRequests', 'edit', 'getUsage', 'lock', 'enable', 'delete', 'create', 'getLicense', 'getRepositories', 'listReferrers']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['createComment', 'create', 'getIssues', 'listPopularPaths', 'getLicense', 'listReferrers', 'getPullRequests', 'edit', 'getUsage', 'update', 'lock', 'disable', 'dispatch', 'getAll', 'get', 'enable', 'list', 'delete']}}},
