...
Correlation ID: node-github-FINAL-1767771600
Generated: 2026-01-07T08:06:34.134489
    ...
    properties = {
        "parameters": [
            ...
            {"name": "operation", "type": NodeParameterType.OPTIONS, "display_name": "Operation", "options": [
                ...
                {"name": "Get", "value": "get", "description": "Get the data of a single issue", "display_options": {'show': {'resource': ['file', 'workflow', 'repository', 'review', 'issue', 'release']}}},
            ...
            {"name": "owner", "type": NodeParameterType.STRING, "display_name": "Repository Owner", "default": "", "required": True, "display_options": {'show': {'operation': ['getAll', 'listPopularPaths', 'createComment', 'getLicense', 'dispatch', 'disable', 'get', 'getRepositories', 'create', 'edit', 'getUsage', 'lock', 'update', 'getIssues', 'delete', 'enable', 'listReferrers', 'list', 'getPullRequests']}}},
            {"name": "repository", "type": NodeParameterType.STRING, "display_name": "Repository Name", "default": "", "required": True, "display_options": {'show': {'operation': ['dispatch', 'getAll', 'listPopularPaths', 'delete', 'disable', 'enable', 'get', 'listReferrers', 'lock', 'createComment', 'list', 'getLicense', 'update', 'create', 'edit', 'getUsage', 'getPullRequests', 'getIssues']}}},
